...
extern uint16   GPIO_input_read(enum GPIO_Name PortPin);
extern void     GPIO_output_off(enum GPIO_Name PortPin);
extern void     GPIO_output_on(enum GPIO_Name PortPin);
